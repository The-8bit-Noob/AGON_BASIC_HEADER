   ...
   70 REM ******************************
   80 :
   90 PRINT TAB(3,4) "MODE 0 = 80x60:16 colours"
  100 PRINT TAB(3,5) "MODE 1 = 80x60:4 colours"
  110 PRINT TAB(3,6) "MODE 2 = 80x60:2 colours"
  120 PRINT TAB(3,7) "MODE 3 = 80x30:64 colours"
  130 PRINT TAB(3,8) "MODE 4 = 80x30:16 colours"
  140 PRINT TAB(3,9) "MODE 7 = 40x25:16 colours:teletext"
  150 PRINT TAB(3,10) "MODE 8 = 40x30:64 colours"
  160 PRINT TAB(3,11) "MODE 12 = 40X25:364 colours"
  170 :
  180 COLOUR 1 : INPUT TAB(3,13)"PICK YOUR SCREEN MODE"; mode%
  190 :
  200 PROC_LOAD_VARS : REM LOAD VARS.
  210 PROC_LOAD_LOGO : REM LOAD UDF CHARS FOR LOGO.
  220 PROC_DRAW_LOGO : REM DRAW LOGO TO SCREEN.
  230 PROC_TITLE_TEXT : REM DRAW TEXT TO SCREEN.
  240 PROC_DRAW_COLOUR_PALETTE : REM DRAW CURRENT PALETTE TO SCREEN.
  250 PROC_READYUP : REM DRAW READY UP TEXT TO SCREEN AND SET PROMPT.
  260 :
  270 NEW : REM CLEAR PROGRAM FROM MEMORY.
